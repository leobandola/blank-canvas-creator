...
export function BetsList({ bets, roundId, isAuthenticated, lotteryType }: { bets: BetWithRelations[], roundId: string, isAuthenticated: boolean, lotteryType: "quina" | "mega_sena" }) {
