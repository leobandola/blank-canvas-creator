                ...
                <div key={bet.id} className="border rounded-lg p-4">
                  <div className="flex items-start justify-between mb-3">
                    <div>
                      ...
                      {bet.player.email && <p className="text-sm text-muted-foreground">{bet.player.email}</p>}
                      {bet.player.phone && <p className="text-sm text-muted-foreground">{bet.player.phone}</p>}
                    </div>
